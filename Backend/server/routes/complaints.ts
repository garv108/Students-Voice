  ...
  app.post(
    ...
    async (req, res) => {
      ...
      try {
        ...
        const data =
          insertComplaintSchema.parse(
            req.body
          );

        const profanityCheck =
          await detectProfanity(
            data.originalText
          );
        ...
        const cluster =
          await storage.getOrCreateCluster(
            analysis.keywords
          );
        ...
        if (cluster) {
          await storage.updateClusterCount(
            cluster.id
          );
        }
    ...
    async (req, res) => {
      ...
      try {
        ...
        const complaintsData =
          await storage.getLeaderboardComplaints();
